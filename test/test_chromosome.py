...
class TestChromosome(unittest.TestCase):
    ...
    def test_constructor(self):
        chrm_1 = Chromosome(1, 3, [1, 0.7, 0.5], None, constitutive_origins=None)
    ...
    def test_base_is_replicated(self):
        chrm_1 = Chromosome(1, 3, [1, 0.7, 0.5], None, constitutive_origins=None)
        chrm_2 = Chromosome(3, 2, [0.7, 0.5], None, constitutive_origins=None)
        chrm_2.strand = [1, 1]
    ...
    def test_replicate(self):
        chrm_1 = Chromosome(1, 6, [1, 0.7, 0.5, 0.3, 0.8, 0.2], None, constitutive_origins=None)
    ...
    def test_set_dormant_origin_activation_probability(self):
        chrm_size = 300000
        chrm_1 = Chromosome(1, chrm_size, [0.5] * chrm_size, None, constitutive_origins=None)
        chrm_2 = Chromosome(1, chrm_size, [0.9] * chrm_size, None, constitutive_origins=None)
